...
alter table "public"."quest_completion" drop constraint "quest_completion_completed_by_raider_id_fkey";
...
alter table "public"."quest" drop constraint "quest_created_by_raider_id_fkey";
