...
export declare type Maybe<T> = T extends PromiseLike<infer U> ? Promise<U | null> : T | null | undefined;
...
export declare type BrightIdStatusResolvers<ContextType = any, ParentType extends ResolversParentTypes['BrightIdStatus'] = ResolversParentTypes['BrightIdStatus']> = {
...
export declare type BoxProfileResolvers<ContextType = any, ParentType extends ResolversParentTypes['BoxProfile'] = ResolversParentTypes['BoxProfile']> = {
...
export declare type CollectiblesFavoritesResolvers<ContextType = any, ParentType extends ResolversParentTypes['CollectiblesFavorites'] = ResolversParentTypes['CollectiblesFavorites']> = {
    address: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    tokenId: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export declare type MolochResolvers<ContextType = any, ParentType extends ResolversParentTypes['Moloch'] = ResolversParentTypes['Moloch']> = {
...
export declare type MemberResolvers<ContextType = any, ParentType extends ResolversParentTypes['Member'] = ResolversParentTypes['Member']> = {
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export declare type TokenBalancesResolvers<ContextType = any, ParentType extends ResolversParentTypes['TokenBalances'] = ResolversParentTypes['TokenBalances']> = {
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
