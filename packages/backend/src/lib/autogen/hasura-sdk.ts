...
export type GetDiscordGuildQueryVariables = Exact<{
  discordId: Scalars['String'];
}>;


export type GetDiscordGuildQuery = (
  { readonly __typename?: 'query_root' }
  & { readonly guild: ReadonlyArray<(
    { readonly __typename?: 'guild' }
    & GuildFragmentFragment
...
export const UpsertAccountDocument = gql`
  ...
  insert_player_account(objects: $objects, on_conflict: $on_conflict) {
    ...
    `;
export const UpsertProfileCacheDocument = gql`
...
export const GetDiscordGuildDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    UpsertProfileCache(variables: UpsertProfileCacheMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpsertProfileCacheMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpsertProfileCacheMutation>(UpsertProfileCacheDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpsertProfileCache');
    },
    ...
    GetDiscordGuild(variables: GetDiscordGuildQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetDiscordGuildQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDiscordGuildQuery>(GetDiscordGuildDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetDiscordGuild');
    },
