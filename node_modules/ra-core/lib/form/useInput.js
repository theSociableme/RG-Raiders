...
var useInput = function (_a) {
    ...
    var sanitizedValidate = Array.isArray(validate)
        ...
        : validate;
    var _b = react_final_form_1.useField(finalName, __assign({ initialValue: initialValue || defaultValue, validate: sanitizedValidate }, options)), input = _b.input, meta = _b.meta;
