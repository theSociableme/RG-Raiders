...
var queryReducer = function (previousState, action) {
    ...
    switch (action.type) {
        ...
        case exports.SHOW_FILTER: {
            ...
            return __assign(__assign({}, previousState), { filter: action.payload.defaultValue
                    ? set_1.default(previousState.filter, action.payload.filterName, action.payload.defaultValue)
        ...
        case exports.HIDE_FILTER: {
            return __assign(__assign({}, previousState), { filter: removeEmpty_1.default(removeKey_1.default(previousState.filter, action.payload)), 
                // we don't use lodash.set() for displayed filters
                // to avoid problems with compound filter names (e.g. 'author.name')
