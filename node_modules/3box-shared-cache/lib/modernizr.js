...
!function (e, n, t) {
  ...
  function i(e) {
    ...
    Modernizr._config.enableClasses && (n += " " + t + e.join(" " + t), E ? S.className.baseVal = n : S.className = n);
  }
  ...
  function a(e, n) {
    if ("object" == (0, _typeof2["default"])(e)) for (var t in e) {
      b(e, t) && a(t, e[t]);
    } else {
      e = e.toLowerCase();
      var r = e.split("."),
  ...
  function m() {
    var e = n.body;
    return e || (e = f(E ? "svg" : "body"), e.fake = !0), e;
  }
  ...
  function y(e, n, o, i) {
    ...
    for (var d, c, p, m, h, y = ["modernizr", "tspan", "samp"]; !L.style && y.length;) {
      d = !0, L.modElem = f(y.shift()), L.style = L.modElem.style;
    }

    for (p = e.length, c = 0; p > c; c++) {
      if (m = e[c], h = L.style[m], l(m, "-") && (m = s(m)), L.style[m] !== t) {
        ...
        if (L.style[m] != h) return a(), "pfx" == n ? m : !0;
      }
    }
  ...
  function g(e, n, t, o, i) {
    ...
    return r(n, "string") || r(n, "undefined") ? y(a, n, o, i) : (a = (e + " " + z.join(s + " ") + s).split(" "), d(a, n, t));
  }
  ...
  w._domPrefixes = z;
  var T = w._config.usePrefixes ? P.split(" ") : [];
  w._cssomPrefixes = T;
