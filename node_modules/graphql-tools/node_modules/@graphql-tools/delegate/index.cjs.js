        ...
        if (source instanceof Error || source === null) {
            ...
            Object.keys(fieldNodes).forEach(responseKey => {
                if (source instanceof graphql.GraphQLError) {
                    nullResult[responseKey] = utils.relocatedError(source, path.concat([responseKey]));
                }
                else if (source instanceof Error) {
                    nullResult[responseKey] = graphql.locatedError(source, fieldNodes[responseKey], path.concat([responseKey]));
                }
                else {
