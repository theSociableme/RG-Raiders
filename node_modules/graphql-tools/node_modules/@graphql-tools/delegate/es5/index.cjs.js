        ...
        if (source instanceof Error || source === null) {
            ...
            Object.keys(fieldNodes_1).forEach(function (responseKey) {
                if (source instanceof graphql.GraphQLError) {
                    nullResult_1[responseKey] = utils.relocatedError(source, path.concat([responseKey]));
                }
                else if (source instanceof Error) {
                    nullResult_1[responseKey] = graphql.locatedError(source, fieldNodes_1[responseKey], path.concat([responseKey]));
                }
                else {
