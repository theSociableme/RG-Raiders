...
var Error = function (props) {
    ...
    return (React.createElement(Fragment, null,
        ...
        React.createElement("div", __assign({ className: classnames(classes.container, className) }, rest),
            ...
            process.env.NODE_ENV !== 'production' && (React.createElement(Accordion, { className: classes.panel },
                React.createElement(AccordionSummary, { expandIcon: React.createElement(ExpandMoreIcon, null) }, translate('ra.message.details')),
