...
var Menu = function (props) {
    ...
    return (React.createElement("div", __assign({ className: classnames(classes.main, (_a = {},
        ...
        resources
            ...
            }, primaryText: getResourceLabel(resource.name, 2), leftIcon: resource.icon ? React.createElement(resource.icon, null) : React.createElement(DefaultIcon, null), onClick: onMenuClick, dense: dense, sidebarIsOpen: open })); }),
        isXSmall && logout));
};
Menu.propTypes = {
