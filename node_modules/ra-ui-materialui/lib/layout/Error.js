...
var Error = function (props) {
    ...
    return (React.createElement(react_1.Fragment, null,
        ...
        React.createElement("div", __assign({ className: classnames_1.default(classes.container, className) }, rest),
            ...
            process.env.NODE_ENV !== 'production' && (React.createElement(Accordion_1.default, { className: classes.panel },
                React.createElement(AccordionSummary_1.default, { expandIcon: React.createElement(ExpandMore_1.default, null) }, translate('ra.message.details')),
                React.createElement(AccordionDetails_1.default, { className: classes.panelDetails },
